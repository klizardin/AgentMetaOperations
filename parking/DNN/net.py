...
class RLModel(tf.keras.Model):
    ...
    def __init__(self):
        ...
        self._input_size = NET_INPUT_SIZE
        self._op_count = OPERATIONS_COUNT
        assert(NET_OPERATION_EXTRA_SIZE>=0)
        self._layers1 = list()
        ...
        self._layers1.append(tf.layers.Dense(NET1_FC_SIZE1, activation=NET_LAYER1_ACTIVATION))
        self._fc_size = self._op_count * NET_OPERATION_ITEM_SIZE + NET_OPERATION_EXTRA_SIZE
        ...
        self._op_layer = OperationLayer(
            ...
            extra_sz=NET_OPERATION_EXTRA_SIZE
        )
        self._layers2 = list()
